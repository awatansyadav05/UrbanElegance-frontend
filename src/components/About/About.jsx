...
import rexx from "../../assets/rexx.webp"
import this2 from "../../assets/this2.jpeg"
...
const About = () => {
    ...
    <>
      <div className='bg-pink-100'>
        ...
        <div className='inset-0 flex items-center justify-center'>
          <h2 className='text-white font-bold text-4xl mt-[-60px] '>
            About Us
          </h2>
        </div>
      </div>
      <section className="text-gray-600 body-font">
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          ...
          <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            <h1 className="title-font sm:text-4xl text-7xl mb-4 font-medium text-gray-900 ">The  <h3 className='font-bold text-2xl font-mono'>Urban<span className='text-red-500'>Elegance</span></h3>
  ...
  <div className="container px-5 py-24 mx-auto ">
    <h1 className="text-4xl font-medium title-font text-gray-900 mb-12 text-center text-semibold">OUR TEAM</h1>
    <div className="flex flex-wrap -m-4">
      <div className="p-4 md:w-1/2 w-full">
        <div className="h-full bg-gray-100 p-8 rounded">
          ...
          <a className="inline-flex items-center">
            <img alt="testimonial" src= {rexx} className="w-12 h-12 rounded-full flex-shrink-0 object-cover object-center"/>
      ...
      <div className="p-4 md:w-1/2 w-full">
        <div className="h-full bg-gray-100 p-8 rounded">
          ...
          <p className="leading-relaxed mb-6">Synth chartreuse iPhone lomo cray raw denim brunch everyday carry neutra before they sold out fixie 90's microdosing. Tacos pinterest fanny pack venmo, post-ironic heirloom try-hard pabst authentic iceland.</p>
          <a className="inline-flex items-center">
            <img alt="testimonial" src={this2} className="w-12 h-12 rounded-full flex-shrink-0 object-cover object-center"/>
            <span className="flex-grow flex flex-col pl-4">
