      ...
      <footer className=' bg-black text-white' >
        <div className='container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col'>
          <div className='w-64 md:mx-0 mx-auto text-center md:text-left'>
            <h3 className='font-bold text-2xl'> Urban<span className='text-red-500'>Elegance</span></h3>
          </div>
        ...
        <div className='bg-gray-500 text-white '>
          <div className='container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row'>
            <p className='text-sm text-center sm:text-left '>
              © 2024 Urban<span className='text-red-500'>Elegance</span>-<span>@Copyright</span>
            ...
            <p className='inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start'>
              ...
              <span className='mr-2'><CiInstagram size={30} /></span>
