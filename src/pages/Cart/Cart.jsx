...
function Cart({ cart , handleDec, handleInc, handleRemove,getTotalPrice,promocode,setPromoCode,applyPromocode, invalid}) {
        ...
        <div className="flex flex-col lg:flex-row shadow-md my-10">
          ...
          <div id="summary" className="lg:w-1/4 bg-white w-full px-8 py-10 ">
            ...
            <div className="py-10">
              ...
              {
                promocode && promocode !=="DISCOUNT10" ? (<span className='text-[red] font-semibold '> {invalid}</span>): (
